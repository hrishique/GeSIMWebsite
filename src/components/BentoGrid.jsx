    ...
    <section className="py-24 bg-white border-t border-slate-100 text-left">
      <div className="max-width-container">
        ...
        <div className="grid md:grid-cols-12 gap-6 items-stretch mb-20">
          ...
          {/* Right Column (2 Flex Columns) */}
          <div className="md:col-span-7 flex flex-col sm:flex-row gap-6">

            {/* Left Column: Browse Securely + Invest Privately */}
            <div className="flex-1 flex flex-col gap-6">

              {/* Tile 2: Browse Securely */}
              <div className="self-start rounded-[18px] bg-[#f7f9fb] border border-[#f1f1f1] p-8 relative overflow-hidden flex flex-col justify-between aspect-[426/340]">
            ...
            {/* Right Column: Virtual Numbers + Spend Freely */}
            <div className="flex-1 flex flex-col gap-6">

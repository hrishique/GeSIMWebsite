...
export default function PosterMarquee() {
  ...
  return (
    <section className="w-full min-h-screen bg-[#F5F5F5] flex flex-col justify-center items-center overflow-hidden py-16 lg:py-24 border-t border-slate-200/60 select-none">
